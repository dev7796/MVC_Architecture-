...
for line in config_file.readlines():
    ...
    print
    "Checking out repo from", line.split()[0], "..."
    ...
    if git_process.returncode == 0:
        ...
        print
        "*** Error checking out repo. Git returned status code", git_process.returncode
        print
        "*** Git messages on stdout: '" + stdout_data + "'."
        print
        "*** Git messages on stderr: '" + stderr_data + "'."
        print
        if not ignore_git_errors:
            print
            """Since the skip-mode is off, these errors need to be fixed before the build process can proceed. In 
...
"""
            ...
            print
            "Continuing with the cloning of directories as skip-mode is active"
            print
            continue
